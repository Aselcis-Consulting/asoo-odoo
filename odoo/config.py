...
class configmanager(object):
    def __init__(self, fname=None):
        ...
        group.add_option("--db_sslrootcert", dest="db_sslrootcert", my_default=False,
                         help="PostgreSQL sslrootcert")
        group.add_option("--db_sslkey", dest="db_sslkey", my_default=False,
                         help="PostgreSQL sslkey")
        group.add_option("--db_sslcert", dest="db_sslcert", my_default=False,
                         help="PostgreSQL sslcert")
